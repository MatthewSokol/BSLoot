...
local moduleName = addonName.."_window_bulk_ep"
local bsloot_window_bulk_ep = bsloot:NewModule(moduleName)
...
function bsloot_window_bulk_ep:OnEnable()
  ...
  editBox:SetCallback("OnEnterPressed",function()
    bsloot:importEpValues(self.editBox:GetText(), self.overwriteFlag:GetValue())
    bsloot_window_bulk_ep:Hide()
  end)
...
function bsloot_window_bulk_ep:Show()
...
function bsloot_window_bulk_ep:Hide()
  if self._big_container.frame:IsShown() then
    self._big_container:Hide()
  end
end
function bsloot_window_bulk_ep:Toggle()
  if self._big_container.frame:IsShown() then
    self._big_container:Hide()
  else
    bsloot_window_bulk_ep:Show()
  end
end
